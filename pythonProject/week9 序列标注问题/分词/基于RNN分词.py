...
class TorchModel(nn.Module):
    def __init__(self, input_dim, hidden_size, num_rnn_layers, vocab):
        ...
        self.run_layer = nn.RNN(input_size= input_dim,
    ...
    def forward(self, x, y=None):
        ...
        x, _ = self.run_layer(x) #output shape:(batch_size, sen_len, hidden_size)
...
def predict(model_path, vocab_path, input_strings):
    ...
    model.eval() # 预测时取消评估模式，即dropout等方法取消使用，让模型预测每个值

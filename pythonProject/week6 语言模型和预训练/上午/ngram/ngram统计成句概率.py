...
# 根据成句的概率去判断句子是否合理，P(AB) = P(B|A)*P(B)。P(今天天气不错)= P(今天天气)*P(不错|今天天气)= P(今天)*P(天气|今天)*P(不错|今天天气)
...
if __name__ == "__main__":
    ...
    print("ngram_count_dict", lm.ngram_count_dict)
    print("ngram_count_prob_dict都有啥", lm.ngram_count_prob_dict)

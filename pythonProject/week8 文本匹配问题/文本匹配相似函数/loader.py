    ...
    def random_train_sample(self):
        ...
        if random.random() <= self.config["positive_sample_rate"]:
            ...
            if len(self.knwb[p]) < 2:
                ...
                # print(input_ids, 'input_idsinput_ids')
        ...
        #随机负样本
            ...
            input_ids = self.encode_sentence(s1, s2)
            input_ids = torch.LongTensor(input_ids)
            # print(input_ids, '0000input_idsinput_ids')
...
# torch自带的DataLoader类封装数据
def load_data(data_path, config, shuffle=True):
    dg = DataGenerator(data_path, config)
    # print(len(dg), 'dggg') #valid: 464, train: 10000
    # print(dg[0], 'dg[0]')
    # [tensor([ 101, 4510,  928, 3302, 1218,  102, 2218, 3221, 6821,  702, 4510, 6413,
    #      102,    0,    0,    0,    0,    0,    0,    0]), tensor([1])]
...
if __name__ == "__main__":
    ...
    dg2 = load_data("../data/train.json", Config)
